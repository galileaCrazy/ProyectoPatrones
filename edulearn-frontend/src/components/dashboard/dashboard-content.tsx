  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto w-full">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <p className="text-sm md:text-base text-muted-foreground">Sistema de Gestión de Aprendizaje EduLearn</p>
      </div>
      ...
      {role === 'admin' && (
        <div className="mb-6 md:mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-foreground mb-4">Herramientas de Administrador</h2>
